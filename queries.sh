...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams INNER JOIN games ON games.winner_id = teams.team_id OR games.opponent_id = teams.team_id WHERE games.round = 'Eighth-Final' AND games.year = 2014")"
